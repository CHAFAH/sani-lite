...
export const companies = mysqlTable("companies", {
  ...
  cvrNumber: varchar("cvrNumber", { length: 20 }),
...
export const payslips = mysqlTable("payslips", {
  ...
  bankAccount: varchar("bankAccount", { length: 50 }),
  payrollRunId: varchar("payrollRunId", { length: 50 }),
  availabilityDate: timestamp("availabilityDate"),
  taxDeduction: decimal("taxDeduction", { precision: 10, scale: 2 }).default("0"),
  companyPension: decimal("companyPension", { precision: 10, scale: 2 }).default("0"),
  holidayData: json("holidayData"),
  balanceData: json("balanceData"),
